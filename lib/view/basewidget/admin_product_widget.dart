...
import '../../helper/admin_product_price_converter.dart';
import '../../helper/price_converter.dart';
import '../screen/product/product_details_screen.dart';

class AdminProductWidget extends StatelessWidget {
  final AdminProduct productModel;
  const AdminProductWidget({Key? key, required this.productModel})
      : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      productModel.discount != null &&
                          ...
                          ? Text(
                              AdminPriceConverter.convertPrice(
          ...
          productModel.discount! > 0
              ? Positioned(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                          AdminPriceConverter.percentageCalculation(
                              context,
