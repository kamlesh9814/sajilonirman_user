    ...
    _screens = [
      NavigationModel(
        ...
        screen: (Provider.of<SplashProvider>(context, listen: false)
                    ...
                    .activeTheme ==
                "default")
            ? const HomePage() //* navigation to home page
      ...
      //*naviagate to last profile section
      NavigationModel(
          name: 'profile',
          icon: Images.profileImage,
          screen: const MoreScreen()),
      // NavigationModel(name: 'cat', icon: Images.homeImage, screen: const AllCategoryScreen())
    ];
