  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            //*top section with name and phone number
            ...
            Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                      //* offer wallet layalty orders card and wishlist
                      const Padding(
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    //     decoration: BoxDecoration(
                    //       border: Border.all(
                    //           color: Colors.white.withOpacity(.07), width: 15),
