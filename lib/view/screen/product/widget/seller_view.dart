...
class _SellerViewState extends State<SellerView> {
  ...
  void initState() {
    ...
    getSellerContactNumber();
    getProductDetailsResponse();
    super.initState();
  }

  // followShop(int id) async{
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<SellerProvider>(
      builder: (context, seller, child) {
        print(
            "sellerviewpage" + seller.sellerModel!.seller!.shop!.id.toString());
                        ...
                        InkWell(
                          onTap: () async {
                            await Provider.of<SellerProvider>(context,
                                    listen: false)
                                .storeFollow(
                                    seller.sellerModel!.seller!.shop!.id,
                                    context);
                            setState(() {
                              getProductDetailsResponse();
                            });
  ...
  void _openWhatsApp() async {
    final Uri whatsappUrl = Uri.parse('whatsapp://send?phone=$sellerphone');
    Uri.parse('https://wa.me/$sellerphone');
