...
class ColorResources {
  ...
  static Color iconBg() {
    return Provider.of<ThemeProvider>(Get.context!).darkTheme ? Theme.of(Get.context!).primaryColor.withOpacity(.05) : const Color(0xffFF6600);
  }
  ...
  static const MaterialColor primaryMaterial = MaterialColor(0xFFFF6600, colorMap);
}
