...
class AppConstants {
  static const String appName = 'Sajilo Nirman';
  static const String slogan = 'E-Commerce Marketplace';
  static const String appVersion = '14.2';
  static const String baseUrl = 'http://sajilonirman.com';
  ...
  static const String adminProductUri = '/api/v1/getAdminProductData';
  ...
  static const String storeFollowApi = '/api/v1/seller/shop-follow/';
  static const String getquestionanswer =
      '/api/v3/seller/answerQuestions/seller';
  static const String askQuestionUri = "/api/v3/seller/askquestion";

  static const String adminChatInfoUri = "/api/v3/seller/messages_view/";
  static const String messageSendtoAdmin = "/api/v3/seller/messages_store";
  // sharePreference
