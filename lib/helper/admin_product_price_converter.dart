...
class AdminPriceConverter {
  static String convertPrice(BuildContext context, dynamic price, {int? discount, String? discountType}) {
  ...
  static dynamic convertWithDiscount(BuildContext context, dynamic price, int? discount, String? discountType) {
    if(discountType == 'amount' || discountType == 'flat') {
      price = price! - discount!;
    }else if(discountType == 'percent' || discountType == 'percentage') {
      price = price! - ((discount! / 100) * price);
  ...
  static dynamic calculation(int amount, int discount, String type, int quantity) {
    dynamic calculatedAmount = 0;
  ...
  static String percentageCalculation(BuildContext context, int? price, int? discount, String? discountType) {
