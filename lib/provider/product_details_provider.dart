...
class ProductDetailsProvider extends ChangeNotifier {
  ...
  AdminProductDetailsModel? _adminProductsDetailsModel;
  AdminProductDetailsModel? get adminProductDetailsModel =>_adminProductsDetailsModel;



   getProductDetails(BuildContext context, String productId) async {
    ...
    if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
      ...
      _productDetailsModel = ProductDetailsModel.fromJson(apiResponse.response!.data);
       print("productD: ${jsonEncode(apiResponse.response!.data)}");
